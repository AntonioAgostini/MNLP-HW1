...
- FT-InB: Finetuned using In-Batch negatives + explicit Negatives
- FT-HN: Finetuned using In-Batch negatives + explicit Hard Negatives
- CE-RR: Finetuned using a CrossEncoder as a ReRanker over FT-HN
